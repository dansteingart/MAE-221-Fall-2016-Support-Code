...
##Notes: MS Exampe 10.5 in better units


"""Air enters the compressor of an ideal Brayton refrigeration cycle at 1 bar, 266 K, with a volumetric flow rate of 1.42(m^3) / s. If the compressor pressure ratio is 3 and the turbine inlet temperature is 300 K, determine (a) the net power input, (b) the refrigeration capacity, (c) the coefficient of performance."""
...
h4 = st[3]['H'] - (st[3]['H']-st['4s']['H'])*eta_c
